...
import com.alili.integration.dialect.primarykey.KeySqlGenerator;
import com.alili.integration.dialect.primarykey.support.DB2KeySqlGenerator;
import com.alili.integration.dialect.primarykey.support.H2KeySqlGenerator;
import com.alili.integration.dialect.primarykey.support.OracleKeySqlGenerator;
import com.alili.integration.dialect.primarykey.support.PostgreKeySqlGenerator;
...
public class KeySqlDialectRegistry {
    ...
    public static final KeySqlDialectRegistry getInstance() {
