...
public class PreMapperStatementBuilder4FindPage extends PreMapperStatementBuilder {
    ...
    public PreMapperStatementBuilder4FindPage(Configuration configuration, MapperBuilderAssistant builderAssistant) {
    ...
    protected Class<?> getParameterTypeClass() {
        /*List<ParameterDefinition> parameterDescs = methodDesc.getParameterDefinitions();
