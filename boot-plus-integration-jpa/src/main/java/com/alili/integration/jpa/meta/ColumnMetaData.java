...
import com.alili.integration.jpa.anotation.MappedStatement;
import com.alili.integration.jpa.anotation.Trigger;
import com.alili.integration.jpa.anotation.TriggerValue;
...
import com.alili.integration.jpa.JoinType;
    ...
    private void init() {
        ...
        if(join) {
            ...
            if(field.isAnnotationPresent(javax.persistence.JoinTable.class)) {
                ...
                //判断是否存在joinColumns
                if(joinTable.joinColumns() != null && joinTable.joinColumns().length > 0) {
                ...
                if(joinTable.inverseJoinColumns() != null && joinTable.inverseJoinColumns().length > 0) {
