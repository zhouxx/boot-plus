 ...
 * @since 1.0
 */
public class PreMapperStatementBuilder4FindOne extends PreMapperStatementBuilder {

    public PreMapperStatementBuilder4FindOne(Configuration configuration, MapperBuilderAssistant builderAssistant) {
    ...
    protected String buildSQL() {
        ...
        /*return "SELECT " + entityMetaData.getColumnNames() + " FROM " + entityMetaData.getTableName()
                + buildWhere();*/
    }
