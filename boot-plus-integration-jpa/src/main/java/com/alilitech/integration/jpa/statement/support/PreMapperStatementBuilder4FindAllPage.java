 ...
 * @since 1.0
 */
public class PreMapperStatementBuilder4FindAllPage extends PreMapperStatementBuilder {

    public PreMapperStatementBuilder4FindAllPage(Configuration configuration, MapperBuilderAssistant builderAssistant, MethodType methodType) {
