 ...
 */
public abstract class DynamicRoutingDataSource extends AbstractDataSource implements InitializingBean {

    /**
     * default datasource routing key
     */
    ...
    public void afterPropertiesSet() {
        ...
        //将默认数据源添加至路由列表
        this.resolvedDataSources.put(DEFAULT_DATASOURCE_KEY, this.resolvedDefaultDataSource);
    }
