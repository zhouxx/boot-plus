...
public class MybatisJpaXMLScriptBuilder extends BaseBuilder {
    ...
    private class BindHandler implements MybatisJpaXMLScriptBuilder.NodeHandler {
        public BindHandler() {
    ...
    private class TrimHandler implements MybatisJpaXMLScriptBuilder.NodeHandler {
        public TrimHandler() {
            // Prevent Synthetic Access
        }
